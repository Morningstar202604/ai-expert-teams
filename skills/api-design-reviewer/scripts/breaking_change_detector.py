...
class BreakingChangeDetector:
    ...
    def __init__(self):
        ...
        self.old_spec: dict | None = None
        self.new_spec: dict | None = None
    ...
    def _extract_operations(self, path_object: dict[str, Any]) -> list[str]:
        ...
        return [method for method in path_object if method.lower() in http_methods]
    ...
    def _compare_request_body(self, base_path: str, old_body: dict | None, new_body: dict | None) -> None:
    ...
    def _compare_security_requirements(self, base_path: str, old_security: list | None, 
                                     new_security: list | None) -> None:
        """Compare security requirements."""
    ...
    def _generate_endpoint_removal_migration(self, removed_path: str, method: str, 
        ...
        for existing_path in remaining_paths:
    ...
    def generate_text_report(self) -> str:
        ...
        if self.report.has_breaking_changes():
            ...
            if breaking_count > 0:
                ...
                lines.extend([
                    "⚠️  MINOR VERSION BUMP RECOMMENDED",
