...
class DashboardGenerator:
    ...
    VISUALIZATION_TYPES: ClassVar[dict] = {
        'latency': 'line_chart',
    ...
    def generate_dashboard_specification(self, service_def: dict[str, Any], 
        ...
        dashboard_spec = {
            'metadata': {
                ...
                'generated_at': datetime.utcnow().isoformat() + 'Z',  # noqa: DTZ003
                'version': '1.0'
            },
            'configuration': {
...
"""
    ...
    def print_summary(self, dashboard_spec: dict[str, Any]):
        ...
        print("  • Role-optimized layout")
        print("  • Service-type specific panels")
