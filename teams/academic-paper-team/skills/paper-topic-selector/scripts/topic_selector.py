...
def _novelty(topic: str, lit_gaps: list | None = None) -> tuple:
...
def evaluate_topic(topic: str, constraints: dict | None = None, lit_gaps: list | None = None) -> dict:
...
def rank(candidates: list, constraints: dict | None = None, lit_gaps: list | None = None,
         top_n: int = 5) -> dict:
